// ─────────────────────────────────────────────────────────────────────────────
// AppColors — EACRMS Brand Color System  (Web / JavaScript)
//
...
//
// These map AppColors entries to the CSS custom-property names used in
// index.css.  Import `cssVarMap` to programmatically set :root variables
// (e.g. in a ThemeProvider), or just reference the table as documentation.
// ─────────────────────────────────────────────────────────────────────────────
